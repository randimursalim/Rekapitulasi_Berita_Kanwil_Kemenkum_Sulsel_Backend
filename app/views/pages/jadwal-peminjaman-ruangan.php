<?php
// app/views/pages/jadwal-peminjaman-ruangan.php
...
<div class="overview peminjaman-ruangan-page <?= $isPegawai ? 'is-pegawai' : '' ?>">
    ...
    <div class="btn-container" style="margin: 15px 0;">
        <button class="btn-tambah" onclick="window.location.href='index.php?page=tambah-peminjaman-ruangan'">
            <i class="fas fa-plus"></i> Tambah Peminjaman Ruangan
        </button>
    </div>
    ...
    <!-- Tabel Jadwal Peminjaman Ruangan -->
    <div class="activity-wrapper" style="margin-top: 20px;">
        <div class="activity">
            <div class="activity-data" id="peminjamanRuanganResults">
...
document.addEventListener('DOMContentLoaded', function () {
  <?php if ($_GET['status'] == 'success'): ?>
    Swal.fire({
      ...
      window.history.replaceState({}, document.title, window.location.pathname + '?page=jadwal-peminjaman-ruangan');
