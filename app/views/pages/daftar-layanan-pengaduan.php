<?php
// app/views/pages/daftar-layanan-pengaduan.php
...
<div class="overview">
    ...
    <div class="btn-container" style="margin: 15px 0;">
        <button class="btn-tambah" onclick="window.location.href='index.php?page=tambah-layanan-pengaduan'">
            <i class="fas fa-plus"></i> Tambah Layanan Pengaduan
        </button>
    </div>
    ...
    <!-- Tabel Layanan Pengaduan -->
    <div class="activity-wrapper" style="margin-top: 20px;">
        <div class="activity">
            <div class="activity-data" id="layananPengaduanResults">
...
<script src="<?= $BASE ?>/js/daftar-layanan-pengaduan.js"></script>
