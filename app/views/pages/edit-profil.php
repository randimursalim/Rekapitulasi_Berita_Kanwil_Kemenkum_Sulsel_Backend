...
<head>
  ...
  <title>Edit Profil - KEMENKUM SULSEL</title>
        ...
        <div class="form-container">
          <form action="#" method="POST" class="input-berita-form" autocomplete="off" enctype="multipart/form-data">
            ...
            <div style="text-align:center; margin-top:20px;">
              ...
              <button type="button" class="btn-batal" onclick="window.location.href='index.html'"><i class="uil uil-times"></i> Batal</button>
            </div>
          </form>
        </div>
        <!-- End Form -->
  ...
  <script>
    ...
    fotoInput.addEventListener('change', function() {
      ...
      if (file) {
        ...
        previewImage.src = 'images/user.jpg'; // kembali ke default jika tidak dipilih
      }
    });
  </script>
