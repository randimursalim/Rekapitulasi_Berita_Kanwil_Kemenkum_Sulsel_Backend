...
// Quarterly SKP - calculate period from triwulan
...
// Set period display text - Quarterly only
...
<head>
    <meta charset="UTF-8">
    <title>SKP Umpan Balik Kuantitatif - <?= htmlspecialchars($employee_name) ?> - <?= htmlspecialchars($periode_display) ?> - <?= htmlspecialchars($tahun) ?></title>
...
<body>
    ...
    <div class="header-title">PERIODE: <?= htmlspecialchars($periode_display) ?> TAHUN <?= htmlspecialchars($tahun) ?></div>
    <br>
