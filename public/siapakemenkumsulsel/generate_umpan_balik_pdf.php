    ...
    <tbody>
        ...
        <?php if (!empty($kinerja_utama)): ?>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars(($first_row['REALISASI_BERDASARKAN_BUKTI_DUKUNG'] ?? '') . (!empty($first_row['SATUAN']) ? ' ' . $first_row['SATUAN'] : '')) ?></td>
                <td class="feedback-cell">
                    <?php if (!empty($first_row['UMPAN_BALIK_STICKER']) && $first_row['UMPAN_BALIK_STICKER'] == 'C'): ?>
                    ...
                    <?php endif; ?>
                    <?= nl2br(htmlspecialchars($first_row['UMPAN_BALIK_DENGAN_BUKTI_DUKUNG'] ?? '')) ?>
                </td>
            </tr>
            <?php 
            ...
            <tr>
                ...
                <td><?= htmlspecialchars(($current_row['REALISASI_BERDASARKAN_BUKTI_DUKUNG'] ?? '') . (!empty($current_row['SATUAN']) ? ' ' . $current_row['SATUAN'] : '')) ?></td>
                <td class="feedback-cell">
                    <?php if (!empty($current_row['UMPAN_BALIK_STICKER']) && $current_row['UMPAN_BALIK_STICKER'] == 'C'): ?>
                        <span style="font-family: 'Wingdings', 'Wingdings 2', 'Wingdings 3', 'Arial', sans-serif; font-size: 18px; color: #000000; margin-right: 8px;">C</span>
                    <?php endif; ?>
                    <?= nl2br(htmlspecialchars($current_row['UMPAN_BALIK_DENGAN_BUKTI_DUKUNG'] ?? '')) ?>
                </td>
            </tr>
            <?php 
            endfor;
