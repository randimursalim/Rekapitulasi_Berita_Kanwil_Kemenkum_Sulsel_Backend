...
// Fetch SKP data from skp_pegawai (for Eselon)
...
// 2. PEJABAT PENILAI KINERJA (atasan)
$penilai_detail = null;
if ($nip_atasan) {
...
<head>
    <meta charset="UTF-8">
    <title>Dokumen Evaluasi Kinerja Pegawai Eselon - <?= htmlspecialchars($periode_display) ?> - <?= htmlspecialchars($tahun) ?></title>
    <style>
