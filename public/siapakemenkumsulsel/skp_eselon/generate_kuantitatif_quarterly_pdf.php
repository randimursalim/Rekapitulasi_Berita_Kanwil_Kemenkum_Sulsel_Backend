...
// Fetch SKP data - Quarterly SKP only (from skp_pegawai)
$is_annual = false;
$skp_data = [];
...
$skp_title = 'Kuantitatif_Quarterly_Eselon';
...
<head>
    <meta charset="UTF-8">
    <title>SKP Kuantitatif Quarterly Eselon - <?= htmlspecialchars($employee_name) ?> - <?= htmlspecialchars($periode_display) ?> - <?= htmlspecialchars($tahun) ?></title>
...
<body>
     <div class="header-title">RENCANA AKSI / SASARAN KINERJA PEGAWAI</div>
