...
$skp_title = 'Umpan_Balik_Kuantitatif';
...
<head>
    <meta charset="UTF-8">
    <title>SKP Umpan Balik Kuantitatif - <?= htmlspecialchars($employee_name) ?> - <?= htmlspecialchars($period) ?> - <?= htmlspecialchars($tahun) ?></title>
...
<body>
     <div class="header-title">REKAMAN INFORMASI UMPAN BALIK BERKELANJUTAN</div>
    <div class="header-title">PENDEKATAN HASIL KERJA KUANTITATIF</div>
    <div class="header-title">BAGI PEJABAT PIMPINAN ADMINISTRASI DAN PEJABAT FUNGSIONAL</div>
