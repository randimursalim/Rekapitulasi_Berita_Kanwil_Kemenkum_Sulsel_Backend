...
// Fetch SKP data from skp_kuantitatif_awal_tahun_pegawai
...
<body>
    ...
    <table class="doc-eval-table" style="margin-top: 15px;">
        ...
        <tr>
            ...
            <td style="text-align: center;">:</td>
            <td class="col-value"><?= htmlspecialchars($pangkat($pg) ?: ($first_row['PANGKAT_GOL_RUANG'] ?? '')) ?></td>
        </tr>
        <tr>
            <td>JABATAN</td>
            <td style="text-align: center;">:</td>
            <td class="col-value"><?= htmlspecialchars($p($pg, 'JABATAN', $first_row['JABATAN'] ?? '')) ?></td>
        </tr>
        <tr>
            <td>UNIT KERJA</td>
            <td style="text-align: center;">:</td>
            <td class="col-value"><?= htmlspecialchars($p($pg, 'UNIT_KERJA', $first_row['UNIT_KERJA'] ?? '')) ?></td>
        </tr>
