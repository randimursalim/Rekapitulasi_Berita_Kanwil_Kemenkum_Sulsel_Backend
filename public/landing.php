...
<body>
  ...
  <section class="section primary-background bg-svg-1">
    ...
    <header id="main-header" class="main-header section-content">
      ...
      <div class="main-header-logo">
        <img src="<?= $BASE ?>/Images/aset_landing.png" alt="Ilustrasi LaMacca - Rekapitulasi Konten Humas"
  ...
  <section id="chatbot" class="section primary-background bg-svg-1">
    <div class="section-content portfolio">
      <div class="full-height ">
        <header class="section-header">
          <h2>Chatbot Lacapila</h2>
          <p>Layanan chatbot pintar kantor wilayah untuk informasi mengenai layanan di kantor wilayah kemenkum sulsel.
          </p>
        </header>
          ...
          <div class="chatbot-demo">
            <div class="chat-window">
              ...
              <div class="chat-input">
                ...
                <a href="https://wa.me/6285787028737" target="_blank" rel="noopener noreferrer"
                  class="chat-button-kirim">Kirim</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="full-height">
        ...
        <div class="layanan-pengaduan-container">
          ...
          <div class="layanan-pengaduan-actions">
            <a href="index.php?page=tambah-layanan-pengaduan-masyarakat" class="btn-view-all" target="_blank"
              rel="noopener noreferrer">
              <i class="fas fa-bullhorn"></i> Ajukan Pengaduan
            </a>
            <a href="index.php?page=tracking-layanan-pengaduan" class="btn-view-all" target="_blank"
              rel="noopener noreferrer">
        ...
        <div class="schedule-container">
          ...
          <div class="schedule-actions">
            <?php if (isset($_SESSION['user'])): ?>
              <a href="index.php?page=tambah-peminjaman-ruangan-masyarakat" class="btn-view-all" target="_blank"
                rel="noopener noreferrer">
                <i class="fas fa-door-open"></i> Pinjam Ruangan
              </a>
            <?php else: ?>
              <a href="index.php?page=login&redirect=tambah-peminjaman-ruangan-masyarakat" class="btn-view-all"
                onclick="alert('Anda harus login terlebih dahulu untuk meminjam ruangan.');">
                <i class="fas fa-door-open"></i> Pinjam Ruangan
              </a>
            <?php endif; ?>
          </div>
  ...
  <?php if (!isset($version))
    $version = '1.0.5'; // Update this number when you make CSS/JS changes ?>
  <script>
